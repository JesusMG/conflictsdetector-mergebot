...
Grab it through the following [link](https://www.microsoft.com/net/download)

Once it's installed, download this project into your computer and use the `dotnet`tool to compile targeting your desired platform (windows-x64 in the example below):
